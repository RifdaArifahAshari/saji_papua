...
SUKU_DATA = {
    "asmat": {
        "nama": 'Suku Asmat',
        "deskripsi": 'Suku Asmat terkenal dengan seni ukiran totem kayu tradisional yang sakral serta sistem kemasyarakatan mereka yang kental dengan upacara adat.',
        "kategori": {
    ...
    "dani": {
        "nama": 'Suku Dani',
        "deskripsi": 'Suku Dani mendiami pegunungan Lembah Baliem. Mereka terkenal dengan upacara bakar batu massal dan penggunaan pakaian adat tradisional.',
        "kategori": {
    ...
    "amungme": {
        "nama": 'Suku Amungme',
        "deskripsi": 'Suku Amungme mendiami dataran tinggi bersalju Papua Tengah. Mereka memandang tanah dan gunung sebagai bagian sakral dari tubuh leluhur.',
        "kategori": {
    ...
    "kamoro": {
        "nama": 'Suku Kamoro',
        "deskripsi": 'Suku Kamoro hidup di sepanjang pesisir selatan Papua. Kebudayaan mereka sangat dipengaruhi oleh lingkungan sungai, laut, dan bakau.',
        "kategori": {
    ...
    "biak": {
        "nama": 'Suku Biak',
        "deskripsi": 'Suku Biak mendiami kepulauan di Teluk Cenderawasih. Mereka dikenal sebagai pelaut tangguh, penjelajah samudera, serta perajin perahu tradisional.',
        "kategori": {
    ...
    "sentani": {
        "nama": 'Suku Sentani',
        "deskripsi": 'Suku Sentani hidup di sekitar perairan Danau Sentani yang indah. Kehidupan mereka berpusat pada perairan, kerajinan lukis kulit kayu, serta festival budaya.',
        "kategori": {
...
ALAT_MUSIK_DATA = [
    {
        "keywords": ['amyem'],
        "nama": 'Amyem',
        "deskripsi": 'Alat musik tiup sejenis trompet dari kayu putih milik Suku Web di Kabupaten Keerom, biasa mengiringi tarian daerah Papua.'
    },
    {
        "keywords": ['atowo'],
        "nama": 'Atowo',
        "deskripsi": 'Alat musik tabuh Papua berbentuk bulat panjang, ringan, dan kecil — dimainkan satu tangan menabuh dengan teknik khusus sebagai hiburan rakyat.'
    },
    {
        "keywords": ['butshake'],
        "nama": 'Butshake',
        "deskripsi": 'Alat musik rattle dari bambu berisi buah kenari asal Muyu, Merauke — digoyang hingga buah kenari saling bertumbuk menghasilkan irama tarian adat.'
    },
    {
        "keywords": ['fu', 'fuu'],
        "nama": 'Fuu',
        "deskripsi": 'Alat musik tiup dari kayu dan bambu khas Suku Asmat Merauke — berfungsi memanggil penduduk dan mengiringi tarian daerah Papua.'
    },
    {
        "keywords": ['kecapi mulut', 'kecapi bambu'],
        "nama": 'Kecapi Mulut',
        "deskripsi": 'Alat musik dari bambu wulu Suku Dani — dijepit di bibir lalu ditiup sambil menarik tali, menghasilkan nada lembut untuk hiburan.'
    },
    {
        "keywords": ['krombi'],
        "nama": 'Krombi',
        "deskripsi": 'Alat musik pukul Suku Tehit dari Sorong Selatan — dimainkan dengan kayu kecil untuk mengiringi tari-tarian dalam upacara adat.'
    },
    {
        "keywords": ['pikon'],
        "nama": 'Pikon',
        "deskripsi": 'Alat musik Suku Dani dengan suara khas yang sumbang — digunakan untuk menghibur diri dan mengisi waktu luang setelah bekerja seharian.'
    },
    {
        "keywords": ['triton', 'terompet kerang', 'terompet keong'],
        "nama": 'Triton',
        "deskripsi": 'Alat musik tiup dari kerang besar Papua — dahulu sebagai sinyal komunikasi dan panggilan darurat antar warga, kini menjadi hiburan tradisional.'
    },
    {
        "keywords": ['yi'],
        "nama": 'Yi',
        "deskripsi": 'Alat musik dari kayu dan bambu berbentuk gempal coklat gelap — suaranya sangat unik, kini semakin langka dan sulit ditemukan.'
    },
]
...
CATEGORY_KEYWORDS = {
    "rumah_adat": ['rumah adat', 'rumah', 'honai', 'jew', 'humai', 'komea', 'rumsram', 'khouw', 'tsyem', 'ebeai', 'karapao', 'tempat tinggal', 'hunian', 'bangunan', 'bentuk rumah', 'arsitektur', 'rumah tradisional', 'kediaman', 'rumah suku', 'arsitektur tradisional', 'rumah papua'],
    "pakaian_laki_laki": ['pakaian adat', 'baju adat', 'pakaian', 'baju', 'busana', 'pakaian laki-laki', 'baju laki-laki', 'pakaian pria', 'koteka', 'kawat penis', 'kawatka', 'sali', 'busana pria', 'pakaian adat cowok', 'aksesoris pria', 'hiasan kepala pria', 'baju tradisional', 'kostum', 'pakaian suku', 'pakaian tradisional', 'pakaian papua'],
    "pakaian_perempuan": ['pakaian adat', 'baju adat', 'pakaian', 'baju', 'busana', 'pakaian perempuan', 'baju perempuan', 'pakaian wanita', 'noken', 'cawat perempuan', 'rok rumbai', 'busana wanita', 'pakaian adat cewek', 'aksesoris wanita', 'perhiasan wanita', 'rok daun', 'rok serat sagu', 'tato perempuan', 'baju tradisional', 'kostum wanita'],
    "makanan": ['makanan', 'kuliner', 'papeda', 'sagu', 'ubi', 'ulat sagu', 'ikan bakar', 'makanan khas', 'hidangan', 'santapan', 'makanan pokok', 'makanan tradisional', 'petatas', 'sayur keladi', 'babi bakar', 'kuliner papua', 'makanan suku', 'camilan'],
    "tarian": ['tarian', 'tari', 'yamate', 'gantar', 'bis', 'perang', 'gemabak', 'edlagan', 'tumbu tanah', 'isosolo', 'yospan', 'war', 'emakwe', 'mboti', 'ehabla', 'gerak tari', 'tari-tarian', 'kesenian tari', 'tari adat', 'pesta tari', 'tari tradisional', 'joget', 'dansa adat'],
    "hari_besar": ['hari besar', 'upacara', 'festival', 'bakar batu', 'mbitoro', 'wamena', 'tikim', 'mboti', 'pesta panen', 'festival budaya', 'ritual', 'tradisi', 'perayaan', 'festival lembah baliem', 'festival asmat', 'festival sentani', 'upacara adat'],
    "alat_musik": ['alat musik', 'musik', 'tifa', 'fu', 'pikon', 'embra', 'okobere', 'gong', 'instrumen', 'bunyi-bunyian', 'alat kesenian', 'kererut', 'kecapi bambu', 'mambisan', 'kase', 'totobuang'],
}
...
FAQ_DATA = [
    {"pattern": re.compile(r'\x08(apa saja|daftar|sebutkan)?s*suku\x08.*\x08papua\x08', re.IGNORECASE), "answer": 'Berdasarkan data yang saya punya, suku-suku di Papua meliputi: Suku Asmat, Suku Dani, Suku Amungme, Suku Kamoro, Suku Biak, dan Suku Sentani.' },
    {"pattern": re.compile(r'\x08ukirans*kayu\x08', re.IGNORECASE), "answer": 'Suku di Papua yang paling terkenal dengan ukiran kayunya adalah **Suku Asmat**.' },
    {"pattern": re.compile(r'\x08(beda|perbedaan)\x08.*\x08(honai|jew|rumsram)\x08', re.IGNORECASE), "answer": 'Perbedaannya terletak pada:\n- **Bentuk & Bahan**: Honai (bulat, jerami), Jew (panjang, panggung, kayu), Rumsram (panggung bentuk perahu terbalik, kayu).\n- **Kapasitas**: Honai (1 keluarga inti), Jew (10-12 KK), Rumsram (2-3 keluarga).\n- **Fungsi**: Honai (tempat tinggal), Jew (pusat upacara & ukir), Rumsram (tempat tinggal pemuda).' },
    {"pattern": re.compile(r'\x08semuas*suku\x08.*\x08koteka\x08', re.IGNORECASE), "answer": 'Tidak semua. Laki-laki Asmat pakai kawat penis (labu kering), Dani dan Amungme pakai koteka, Kamoro pakai kawatka, Biak dan Sentani pakai cawat/sali dari kain/kulit kayu.' },
    {"pattern": re.compile(r'\x08makanan\x08.*\x08umum\x08', re.IGNORECASE), "answer": 'Makanan khas Papua yang paling umum di semua suku adalah Papeda, sagu bakar, ulat sagu, ikan bakar, dan ubi jalar.' },
    {"pattern": re.compile(r'\x08semuas*suku\x08.*\x08taris*perang\x08', re.IGNORECASE), "answer": 'Hampir semua memiliki, contoh: Tari Yamate (Asmat), Tari Perang (Dani), Tari Ehabla (Sentani), Tari War (Biak).' },
    {"pattern": re.compile(r'\x08festival\x08.*\x08(terbesar|papua)\x08', re.IGNORECASE), "answer": 'Nama festival budaya terbesar di Papua dari data tersebut adalah Festival Lembah Baliem (Dani), Festival Asmat, Festival Danau Sentani, dan Festival Pesisir Biak.' },
    {"pattern": re.compile(r'\x08(tinggal|rumah|suku)\x08.*\x08(atass*air|danau)\x08', re.IGNORECASE), "answer": 'Ada, yaitu Suku Sentani (rumah Khouw di atas Danau Sentani) dan sebagian suku Kamoro di pesisir.' },
    {"pattern": re.compile(r'\x08rumahs*adat\x08.*\x08perahus*terbalik\x08', re.IGNORECASE), "answer": 'Suku yang punya rumah adat berbentuk perahu terbalik adalah **Suku Biak** dengan rumah adat **Rumsram**.' },
    {"pattern": re.compile(r'\x08(apas*itus*noken|suku.*noken|menggunakans*noken)\x08', re.IGNORECASE), "answer": 'Noken adalah tas anyaman dari serat atau kulit kayu, yang digunakan oleh perempuan Dani, Amungme, Kamoro, Sentani, dan lainnya.' },
    {"pattern": re.compile(r'\x08suku\x08.*\x08tato\x08', re.IGNORECASE), "answer": 'Suku yang terkenal dengan tato di tubuh perempuannya adalah **Suku Kamoro** (dengan tato motif lingkaran dan garis).' },
    {"pattern": re.compile(r'\x08alats*musik\x08.*\x08keong\x08', re.IGNORECASE), "answer": 'Ya, ada Suku Asmat (menggunakan Embra) dan Suku Kamoro (menggunakan Okobere).' },
    {"pattern": re.compile(r'\x08wisata\x08.*\x08mudahs*dijangkau\x08', re.IGNORECASE), "answer": 'Relatif paling mudah dijangkau: Lembah Baliem (Dani) via Wamena, Danau Sentani via Jayapura, Pulau Biak, dan Agats (Asmat) tapi aksesnya lebih terbatas.' },
    {"pattern": re.compile(r'\x08perbedaan\x08.*\x08(pegunungan|pesisir)\x08', re.IGNORECASE), "answer": 'Perbedaan utama antara suku pegunungan (Dani, Amungme) dan pesisir (Asmat, Kamoro, Biak):<br>- **Rumah adat**: Honai/Humai vs Jew/Komea/Rumsram<br>- **Pakaian**: Koteka vs kawat penis/cawat<br>- **Makanan pokok**: Ubi jalar dominan vs sagu dominan<br>- Tarian dan budaya lainnya.' },
    {"pattern": re.compile(r'\x08(mempertahankan|budayas*asli)\x08', re.IGNORECASE), "answer": 'Masih, tapi dengan tingkat yang berbeda-beda; festival dan upacara adat masih rutin digelar.' },
    {"pattern": re.compile(r'\x08(wisata|kunjungi|berkunjung|tempats*menarik|lembahs*baliem|danaus*sentani|rajas*ampat)\x08', re.IGNORECASE), "answer": 'Berikut adalah beberapa destinasi wisata budaya yang sangat direkomendasikan untuk Anda kunjungi di Papua:<br>- **Lembah Baliem** (Suku Dani): Menikmati pesona alam pegunungan dan Festival Lembah Baliem pada bulan Agustus.<br>- **Danau Sentani** (Suku Sentani): Keindahan danau, desa terapung, dan Festival Danau Sentani pada pertengahan tahun.<br>- **Biak** (Suku Biak): Menyajikan pesona pesisir, laut yang indah, serta Festival Pesisir Biak.<br>- **Agats** (Suku Asmat): Pusat eksplorasi seni ukiran kayu tradisional Suku Asmat yang eksotis.' },
]
...
def generate_chatbot_response(query):
    ...
    CATEGORY_KEYWORDS = {
        ...
        "tarian": [
            ...
            "tumbu tanah", "isosolo", "yospan", "war", "ehabla", 
